...
#define BGFX_TEXTURE_EXPORT                       UINT64_C(0x0001000000000000) //!< Texture will be exported to external memory.
#define BGFX_TEXTURE_IMPORT                       UINT64_C(0x0002000000000000) //!< Texture will be imported from external memory.
...
#define BGFX_CAPS_EXTERNAL_MEMORY                 UINT64_C(0x0000000100000000) //!< External textures are supported.
